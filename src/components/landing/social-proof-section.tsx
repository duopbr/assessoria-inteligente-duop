        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 rounded-lg bg-gradient-to-br from-duop-blue/5 to-duop-purple/5 border border-duop-purple/10">
            ...
            <ul className="space-y-2 text-duop-gray-dark">
              <li>✓ Ex-gestores e estrategistas</li>
              <li>✓ Grandes assessorias</li>
              <li>✓ Mestres, Doutores e PhDs</li>
            </ul>
          </div>

          <div className="text-center p-6 rounded-lg bg-gradient-to-br from-duop-purple/5 to-duop-blue/5 border border-duop-blue/10">
            <div className="text-4xl mb-4">🤝</div>
            <h3 className="text-xl font-bold mb-4 text-duop-blue">Validação</h3>
            <ul className="space-y-2 text-duop-gray-dark">
              <li>✓ +3.000 assessores acompanhando</li>
              <li>✓ Co-criada com assessores</li>
              <li>✓ XP, BTG e Warren</li>
            </ul>
          </div>

          <div className="text-center p-6 rounded-lg bg-gradient-to-br from-duop-blue/5 to-duop-purple/5 border border-duop-purple/10">
            <div className="text-4xl mb-4">📈</div>
            <h3 className="text-xl font-bold mb-4 text-duop-blue">Resultado</h3>
            <ul className="space-y-2 text-duop-gray-dark">
              <li>✓ Economize até 5h/semana</li>
              <li>✓ Atenda mais clientes</li>
              <li>✓ Menos estresse operacional</li>
            </ul>
          </div>
        </div>
      </div>
